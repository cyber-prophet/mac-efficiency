- Курс эффективности работы на Mac
	  ...
	  collapsed:: true
		- Максим Уваров   [maxim-uvarov.com](https://maximuvarov.com)
		  collapsed:: true
			...
			- Консультант
				- Озон [https://www.ozon.ru/](https://www.ozon.ru/)
				- Литрес [https://www.litres.ru/](https://www.litres.ru/)
				- Островок [https://ostrovok.ru/?sid=72f31b5b-4853-4b75-b182-2bf81903631d](https://ostrovok.ru/?sid=72f31b5b-4853-4b75-b182-2bf81903631d)
				- другие
	...
	- Фишки Mac
		- Горячие клавиши MacOS
			...
			- Правило - их не нужно учить впрок, но по случаю, если вы их часто используете {{embed [[QmbKJKePyuuuC1WQfwKcNSwrzwgUNRZAiUq9DafQj7d9YR]]}}
			- `CMD + Q`
			  collapsed:: true
				- Выход из приложения
				- `ALT + F4` (Windows)
